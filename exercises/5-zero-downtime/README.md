...
Rolling update will be done o each HANA instance one-at-a-time (50%) and it will be rebooted at any given time, because 
...
**Lab 5 - Promote Rolling OS Update and Verify**
...
In this exercise you will run through the same job template as in the previous lab **Lab 5 - Rolling Update**. This time you want to run on both HANA systems in parallel.
